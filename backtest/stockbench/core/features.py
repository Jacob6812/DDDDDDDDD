...
import pandas as pd
try:
    from backtest.stockbench.core.schemas import FeatureInput, TechSnapshot, NewsSnapshot, PositionState
except ImportError:
...
def build_features_for_prompt(
    ...
    try:
        ...
        # Not limited by include_price here, because fundamental data calculation requires price
        try:
